...
?>
<div >
	<h3 style='text-align: center;'><?php echo JText::_( "Order Detail" ); ?></h3>
</div>
	...
	<table class="orders" >
		...
		<tr>
			<td> <strong><?php echo JText::_("Customer Note"); ?></strong><br/></td>
			<td> 
			 <table class="paymentTable">
				<tr>
					<td colspan="2"><?php echo $row->customer_note; ?> </td>
				</tr>
				</table>
			</td>	
		</tr>
	...
	<div id="items_info">
		<h3 style='text-align: center;'><?php echo JText::_("Items in Order"); ?></h3>
		
		<table id="cart_order" class="" style="clear: both;">
		<thead>
			<tr>
                <th style="text-align: left;"><?php echo JText::_("Item"); ?></th>
                <th style="width: 192px; text-align: center;"><?php echo JText::_("Quantity"); ?></th>
                <th style="width: 192px; text-align: right;"><?php echo JText::_("Amount"); ?></th>
			</tr>
		</thead>
		<tbody>
		<?php $i=0; $k=0; ?>
