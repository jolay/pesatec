<?php
/**
 * @version		$Id: categorieslatest.php 1503 2012-02-28 15:48:24Z lefteris.kavadas $
 * @package		K2
...
class JElementCategoriesLatest extends JElement
{
	...
	function fetchElement($name, $value, &$node, $control_name){
		...
		$document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/k2.modules.css?v=2.5.5');
