<?php
/**
 * @version		$Id: admin.k2.php 1507 2012-03-01 20:39:22Z joomlaworks $
 * @package		K2
...
// CSS
$document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/k2.css?v=2.5.5');
...
$document->addScript(JURI::root(true).'/media/k2/assets/js/k2.js?v=2.5.5');
...
<div id="k2AdminFooter">
	<a target="_blank" href="http://getk2.org/">K2 v2.5.5</a> | Copyright &copy; 2006-<?php echo date('Y'); ?> <a target="_blank" href="http://www.joomlaworks.net/">JoomlaWorks Ltd.</a>
</div>
<?php endif;
